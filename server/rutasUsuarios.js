...
Router.get('/demo', function(req, res) {
  Usuarios.find({user: req.query.user}).count({}, function(err, count) { //Verificar si existe el usuario DEMO
    if(count>0){ //Si el registro es mayor a 0
        res.send("Utilice los siguientes datos: </br>usuario: demo | password:123456 </br>usuario: alvaro | password:123456") //Mostrra mensaje con los datos de los usuarios predeterminados
    }else{
